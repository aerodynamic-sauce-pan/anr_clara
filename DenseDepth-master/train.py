...
parser.add_argument('--gpus', type=int, default=0, help='The number of GPUs to use')
parser.add_argument('--gpuids', type=str, default='0', help='IDs of GPUs to use')
parser.add_argument('--mindepth', type=float, default=0.001, help='Minimum of input depths')
parser.add_argument('--maxdepth', type=float, default=255, help='Maximum of input depths')
parser.add_argument('--name', type=str, default='densedepth_nyu', help='A name to attach to the training session')
parser.add_argument('--checkpoint', type=str, default='kitti.h5', help='Start training from an existing model.')
